...
#	myspeeddial_app.t 19/12/15

#	usage on command line in myspeeddial directory :
#	set catalyst_debug=0
#	perl -w -Ilib t/myspeeddial_app.t

# 	OR prove -wl t in myspeeddial directory

use strict;
use warnings;
use Test::More;
 
#BEGIN { use_ok("Test::WWW::Mechanize::Catalyst" => "MySpeedDial") }
use Test::WWW::Mechanize::Catalyst "MySpeedDial";
 
my $user = Test::WWW::Mechanize::Catalyst->new;

$user->get_ok("http://localhost:3000/myspeeddial", "Goto Localhost/MySpeedDial");
$user->title_is("My Perl Speed Dial - Home", "Check title is 'My Perl Speed Dial - Home'");
$user->get_ok("http://localhost:3000/myspeeddial/home", "Goto MySpeedDial/home");
$user->title_is("My Perl Speed Dial - Home", "Check title is 'My Perl Speed Dial - Home'");
